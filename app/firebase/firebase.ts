...
export {auth, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut, getDocs, query, where, getDoc, onAuthStateChanged, updateDoc, setDoc, doc, db, collection, addDoc, arrayRemove, arrayUnion }